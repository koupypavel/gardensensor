#include "mqtt_task.h"
static const char *TAG = "gs_mqtt_task";
...
static void mqtt5_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        msg_id = esp_mqtt_client_publish(client, "/gsensor/sen_a", "data_3", 0, 1, 1);
...
void mqtt5_app_start(void)
{
    ...
    esp_mqtt_client_config_t mqtt5_cfg = {
        .broker.address.uri = "mqtt://10.0.0.5",
        .session.protocol_ver = MQTT_PROTOCOL_V_5,
        .broker.address.port = 1883,
        .network.disable_auto_reconnect = true,
        .credentials.username = "garden",
        .credentials.authentication.password = "Garden2541",
