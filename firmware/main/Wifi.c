...
*/
#define EXAMPLE_ESP_WIFI_SSID1      "CatNet"
#define EXAMPLE_ESP_WIFI_PASS1      "Pinda1452."
...
void initWifiSoftap(char *ssid, char *password)
{
    ...
    IP4_ADDR(&ipInfo.ip, 8, 8, 8, 8);
    IP4_ADDR(&ipInfo.gw, 8, 8, 8, 8);
...
void wifi_init_sta(void)
{
    ...
    wifi_config_t wifi_config = {
        .sta = {
            .ssid = EXAMPLE_ESP_WIFI_SSID1,
            .password = EXAMPLE_ESP_WIFI_PASS1,
    ...
    if (bits & WIFI_CONNECTED_BIT)
    {
        ESP_LOGI(TAG, "connected to ap SSID:%s password:%s",
                 EXAMPLE_ESP_WIFI_SSID, EXAMPLE_ESP_WIFI_PASS1);
    }
